...
def predict(imgpath):
    ...
    parameters_output = {}
    data = [imgpath]
    detect = dd.post_predict(
        sname, data, parameters_input, parameters_mllib, parameters_output)
...
parser.add_argument('--stepsize', type=int, default=512,
...
parameters_input = {'connector': 'image', 'width': args.stepsize,
                    'height': args.stepsize, 'scale': 0.0039}
